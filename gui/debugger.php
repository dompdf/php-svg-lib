 ...
 *
 * Debugging GUI from the dompdf project (http://dompdf.github.io)
 */
...
<html lang="en">
<head>
  <title>SVG lib debugging tool</title>
  ...
  <script type="text/javascript">
    function updateAddress(){
      ...
      if ( !/[a-z]+:\/\//.test(address) ) {
        addressHTML = "svg/"+address+"?"+(new Date).getTime();
      }
      ...
      setTimeout(function(){
        address = "display.php?file="+addressPDF;
